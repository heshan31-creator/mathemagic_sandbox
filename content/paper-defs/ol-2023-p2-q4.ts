...
// NOTE: Sinhala (si) strings have been verified for O/L mathematical register.
// Tamil (ta) strings remain machine-assisted and require native educator review.
export const OL_2023_P2_Q4: ExamDefinition = {
  id: "ol-2023-paper-2-q4",
  title: {
    si: "සංයුක්ත රූපය — අර්ධ වෘත්තයක් ඉවත් කළ සෘජුකෝණාස්‍රය",
  ...
  steps: [
    {
      id: "step-1-radius",
      title: { 
        si: "අර්ධ වෘත්තයේ අරය සොයන්න", 
        // TODO: needs native speaker review
        ta: "அரைவட்டத்தின் ஆரையைக் காணவும்" 
      },
      prompt: {
        si: "අර්ධ වෘත්තයේ විෂ්කම්භය සෘජුකෝණාස්‍රයේ පළල වන 14cm ට සමාන වේ. එහි අරය කුමක්ද?",
        // TODO: needs native speaker review
      ...
      hintText: {
        si: "අරය යනු විෂ්කම්භයෙන් අඩකි — දී ඇති පළල 2 න් බෙදන්න.",
        // TODO: needs native speaker review
    ...
    },
    {
      ...
      title: { 
        si: "අර්ධ වෘත්තයේ වර්ගඵලය සොයන්න", 
        // TODO: needs native speaker review
        ta: "அரைவட்டத்தின் பரப்பளவைக் காணவும்" 
      },
      prompt: {
    ...
    },
    {
      ...
      title: { 
        si: "සෘජුකෝණාස්‍රයේ වර්ගඵලය සොයන්න", 
        // TODO: needs native speaker review
        ta: "செவ்வகத்தின் பரப்பளவைக் காணவும்" 
      },
      prompt: {
      ...
      hintText: {
        si: "සෘජුකෝණාස්‍රයක වර්ගඵලය = දිග × පළල.",
        // TODO: needs native speaker review
    ...
    },
    {
      ...
      title: { 
        si: "සංයුක්ත රූපයේ වර්ගඵලය සොයන්න", 
        // TODO: needs native speaker review
        ta: "கூட்டு உருவத்தின் பரப்பளவைக் காணவும்" 
      },
      prompt: {
      ...
      hintPenaltyPercent: 25,
      hintText: {
        si: "අර්ධ වෘත්තය සෘජුකෝණාස්‍රයෙන් ඉවත් කර ඇති බැවින්, 3 වන පියවරේ පිළිතුරෙන් 2 වන පියවරේ පිළිතුර අඩු කරන්න.",
        // TODO: needs native speaker review
